                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: CustomShadow(
                                ...
                                color: Colors.grey,
                                offset: controller.gridPressed.value
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    borderRadius: const BorderRadius.all(
                                        Radius.circular(8)),
                                    color: controller.gridPressed.value
                                        ? orangeColor
                                        : Colors.white,
                                  ),
                                  height: 48,
                            ...
                            GestureDetector(
                              ...
                              child: CustomShadow(
                                ...
                                color: Colors.grey,
                                offset: controller.listPressed.value
                                    ? const Offset(0.5, 0.5)
                                    : const Offset(1, 1),
                                child: Container(
                                  decoration: BoxDecoration(
                                    borderRadius:
                                        BorderRadius.all(Radius.circular(8)),
                                    color: controller.listPressed.value
                                        ? orangeColor
                                        : Colors.white,
                                  ),
                                  height: 48,
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Padding(
                                  ...
                                  child: FoodVertialContainer(
                                    ...
                                    onPressed: controller.onPress[index],
                                    themeValue: 1,
                                  ),
                                );
                              });
