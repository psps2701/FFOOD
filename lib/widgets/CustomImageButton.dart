...
class CustomImageButton extends StatefulWidget {
   ...
   CustomImageButton({super.key, required this.imagePath});


  var imagePath = "";

  @override
  State<CustomImageButton> createState() => _CustomBackButtonState();
}

class _CustomBackButtonState extends State<CustomImageButton> {
