...
class RestaurantProfileController extends GetxController with StateMixin<dynamic> {

  var gridPressed = false.obs;

  var tagBoxLabel = ["PIZZA", "Chicken", "Fast Food"].obs;
  ...
  List<String> tabItems = ["All", "Legends", "Bundles", "AdditionalBundles"].obs;
  int current = 0;

  List<String> dishName = ["Pizze", "Pizza Napolitana", "Margarita"].obs;
  List<String> saladName = ["Ceasar’s Salad", "Chef’s Salad", "Green Salad"].obs;
